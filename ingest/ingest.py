...
CONFIG: dict[str, dict] = {
    ...
    "CSPViolation": {
        "table": "csp_violation_events",
        "column_map": {
            "TIMESTAMP_DERIVED":           "timestamp",
            "EVENT_TYPE":                  "event_type",
            "REQUEST_ID":                  "request_id",
            "BLOCKED_URI":                 "blocked_uri",
            "BLOCKED_URI_DOMAIN":          "blocked_uri_domain",
            "DIRECTIVE":                   "directive",
            "CONTEXT":                     "context",
            "UNIQUE_ID":                   "unique_id",
        ...
        "numeric_cols": ['column_number', 'line_number'],
        "interval": "Hourly",
    },

    "ContentDistribution": {
        "table": "content_distribution_events",
        "column_map": {
            "TIMESTAMP_DERIVED":           "timestamp",
            "EVENT_TYPE":                  "event_type",
            "REQUEST_ID":                  "request_id",
    ...
    "Sandbox": {
        ...
        "column_map": {
            ...
            "ORGANIZATION_ID":             "organization_id",
            "PENDING_SANDBOX_ORG_ID":      "pending_sandbox_org_id",
            "CURRENT_SANDBOX_ORG_ID":      "current_sandbox_org_id",
            "STATUS":                      "status",
            "USER_ID":                     "user_id",
        },
        "numeric_cols": [],
    ...
    "PlatformEncryption": {
        "table": "platform_encryption_events",
        "column_map": {
            "TIMESTAMP_DERIVED":           "timestamp",
            "EVENT_TYPE":                  "event_type",
            "REQUEST_ID":                  "request_id",
    ...
    "VisualforceRequest": {
        "table": "visualforce_request_events",
        "column_map": {
            "TIMESTAMP_DERIVED":           "timestamp",
            "EVENT_TYPE":                  "event_type",
            "REQUEST_ID":                  "request_id",
            ...
            "MANAGED_PACKAGE_NAMESPACE":   "managed_package_namespace",
            "IS_AJAX_REQUEST":             "is_ajax_request",
            "DB_BLOCKS":                   "db_blocks",
            "DB_CPU_TIME":                 "db_cpu_time",
            "CLIENT_IP":                   "client_ip",
        },
        "numeric_cols": ['run_time', 'cpu_time', 'db_total_time', 'request_size', 'response_size', 'view_state_size', 'db_blocks', 'db_cpu_time'],
        "interval": "Hourly",
    },

    "ApexRestApi": {
        "table": "apex_rest_api_events",
        "column_map": {
            "TIMESTAMP_DERIVED":           "timestamp",
            "EVENT_TYPE":                  "event_type",
            "REQUEST_ID":                  "request_id",
        ...
        "numeric_cols": ['run_time', 'cpu_time', 'db_total_time', 'status_code', 'rows_processed', 'number_fields', 'db_blocks', 'db_cpu_time', 'request_size', 'response_size'],
        "interval": "Hourly",
    },
    ...
    "Sites": {
        ...
        "numeric_cols": ['run_time', 'cpu_time', 'db_total_time', 'response_size'],
        "interval": "Hourly",
    },

    "BulkApiRequest": {
        "table": "bulk_api_request_events",
        "column_map": {
            "TIMESTAMP_DERIVED":           "timestamp",
            "EVENT_TYPE":                  "event_type",
            "REQUEST_ID":                  "request_id",
        ...
        "numeric_cols": ['run_time', 'cpu_time', 'status_code'],
        "interval": "Hourly",
    },

    "DatabaseSave": {
        "table": "database_save_events",
        "column_map": {
            "TIMESTAMP_DERIVED":           "timestamp",
            "EVENT_TYPE":                  "event_type",
            "REQUEST_ID":                  "request_id",
        ...
        "numeric_cols": ['num_rows', 'sample_factor'],
        "interval": "Hourly",
    },

    "CompositeApiSubrequest": {
        "table": "composite_api_subrequest_events",
        "column_map": {
            "TIMESTAMP_DERIVED":           "timestamp",
            "EVENT_TYPE":                  "event_type",
            "REQUEST_ID":                  "request_id",
            ...
            "SUCCESS":                     "success",
            "STATUS_CODE":                 "status_code",
            "INITIAL_REFERENCE_IDS":       "initial_reference_ids",
            "CLIENT_IP":                   "client_ip",
        },
        "numeric_cols": ['run_time', 'cpu_time', 'db_total_time', 'status_code'],
        "interval": "Hourly",
    },

    "QueuedExecution": {
        "table": "queued_execution_events",
        "column_map": {
            "TIMESTAMP_DERIVED":           "timestamp",
            "EVENT_TYPE":                  "event_type",
            "REQUEST_ID":                  "request_id",
        ...
        "numeric_cols": ['run_time', 'cpu_time', 'db_total_time'],
        "interval": "Hourly",
    },

    "CompositeApi": {
        "table": "composite_api_events",
        "column_map": {
            "TIMESTAMP_DERIVED":           "timestamp",
            "EVENT_TYPE":                  "event_type",
            "REQUEST_ID":                  "request_id",
            ...
            "IS_REQUEST_COLLATION_ON":     "is_request_collation_on",
            "NUM_RETRIES":                 "num_retries",
            "NUM_GRAPH_DEPTH":             "num_graph_depth",
            "CLIENT_IP":                   "client_ip",
        },
        "numeric_cols": ['run_time', 'cpu_time', 'num_retries', 'num_graph_depth'],
        "interval": "Hourly",
    },
}
